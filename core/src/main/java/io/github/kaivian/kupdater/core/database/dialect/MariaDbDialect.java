...
public class MariaDbDialect implements DatabaseDialect {
    ...
    public String getCreateSchemaHistoryTableSql(String tableName) {
        ...
        return "CREATE TABLE IF NOT EXISTS " + quotedTable + " ("
                ...
                + quoteIdentifier("installed_on") + " DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, "
                + quoteIdentifier("execution_time") + " INT NOT NULL, "
                + quoteIdentifier("success") + " TINYINT(1) NOT NULL"
    ...
    public String buildUpsertQuery(String tableName, String[] primaryKeyColumns, String[] updateColumns) {
        ...
        for (String col : updateColumns) {
            ...
            updateJoiner.add(q + " = VALUES(" + q + ")");
        }

        return "INSERT INTO " + quotedTable + " ON DUPLICATE KEY UPDATE " + updateJoiner;
    }
}
